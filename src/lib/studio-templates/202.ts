...
/**
 * Gera o HTML do template 202
 */
export function generate202Html(input: Template202Input): string {
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .texto3 {
      font-size: 39px;
      font-weight: ${content.texto3Bold ? "700" : "400"};
      letter-spacing: -1.17px;
      line-height: 1.3;
      color: ${style.textColor};
    }

    /* Footer com swipe (se aplicável) */
    .footer {
      margin-top: auto;
      padding-top: 30px;
    }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      ${content.texto3 ? `<p class="texto3">${escapeHtml(content.texto3)}</p>` : ""}
    </div>
