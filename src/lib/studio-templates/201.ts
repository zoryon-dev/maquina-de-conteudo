...
export interface Template201Input {
  slide: StudioSlide;
...
/**
 * Gera o HTML do template 201
 */
export function generate201Html(input: Template201Input): string {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="texto2">${escapeHtml(content.texto2)}</p>
