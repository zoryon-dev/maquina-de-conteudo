/**
 * Template DARK_MODE - Fundo escuro com gradiente
 *
 * Layout:
 * - Header com ano e brand
 * - Headline grande com destaque colorido
 * - Descrição em tom menor
 * - CTA "Arraste para o lado" (opcional)
 * - Footer com créditos
 *
...
/**
 * Gera o HTML do template DARK_MODE
 */
export function generateDarkModeHtml(input: TemplateDarkModeInput): string {
